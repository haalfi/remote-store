...
4. **Single source of truth**: Authoritative reference tables live in one place—link to them, don't copy. Examples: ripple-check, CHANGELOG section order, backlog ID format. Copies become stale.
