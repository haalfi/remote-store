...
See the [Write Integrity guide](../../how-to/write-integrity.md) for usage examples
and the [ext.write spec](../../explanation/design/specs/046-ext-write.md) for invariants.
