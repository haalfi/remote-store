...
- [ADR-0025](../explanation/design/adrs/0025-async-to-sync-backend-adapter.md)
  — decision record for `AsyncBackendSyncAdapter`
- [spec 029 § AsyncBackendSyncAdapter](../explanation/design/specs/029-async-store-backend-api.md)
