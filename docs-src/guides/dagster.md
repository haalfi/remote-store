...
both the [bytes-serializer IO manager](../reference/api/extensions/dagster.md) and the
[dataset IO manager](../reference/api/extensions/dagster.md#remote_store.ext.dagster.dagster_dataset_io_manager).
