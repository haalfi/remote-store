...
| [Hive partition helpers](https://docs.remotestore.dev/stable/api/extensions/partition/) | Build and parse `year=2026/month=03/` paths with `partition_path()` and `parse_partition()` |
