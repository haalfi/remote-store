...
!!! info "Why `config_kwargs`, not `client_kwargs['config']`"
    ...
    [S3-026](../../explanation/design/specs/008-s3-backend.md#s3-026) pins the routing:
...
- [S3 backend example](../../tutorial/examples/s3-backend.md)
- [S3 listing strategies example](../../tutorial/examples/s3-listing-strategies.md) — demonstrates shallow, recursive, and filtering techniques
