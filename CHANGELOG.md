...
- BK-369: Scheduled CI now installs each extra at the floor of every range it declares and runs its smoke there, so the dependency policy's "not a continuously verified floor" rule states what is checked weekly rather than that nothing is.
