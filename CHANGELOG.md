...
- ID-160: `context7.json` — shorten rules 3, 6, 8 to ≤255 chars (Context7 schema limit). Refresh of `/haalfi/remote-store` was failing validation: `rules.3: String exceeds maximum length of 255; rules.6: ...; rules.8: ...`. Content semantics preserved.
