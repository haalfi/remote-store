...
- ID-174: backlog item filed — Diátaxis-aligned docs filesystem reorg (split `guides/` into `tutorials/`, `how-to/`, `reference/`, `explanation/`, `further/`). Sequenced after ID-161 (`llms.txt`).
