...
| `scripts/check_conda_recipe_pins.py` | packaging/conda-forge/recipe.yaml run_constraints <-> pyproject.toml [project.optional-dependencies] | intent <-> realization | `all`, `lint` | gating |
