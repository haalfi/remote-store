...
window the calendar puts on a published promise is derived rather than
remembered at release time (BK-377); the watch's issue survives a single-extra
re-run (BUG-282) and its one legacy-sftp
