...
- **D5** — the posting half is measured above and stays as written. The
  ...
  alongside `ship-report` and the wiring is still owed (BK-384).
...
in this section remains the pilot's, read over PRs #1021 to #1023. BK-384
