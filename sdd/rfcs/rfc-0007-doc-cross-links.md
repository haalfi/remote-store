...
|---|---|---|
| `api/store.md` | Getting Started, Concurrency | Quickstart |
| `api/path.md` | Getting Started | Path Model |
| `api/config.md` | Retry, Security | Configuration, Retry Policy |
| `api/registry.md` | Choosing a Backend | Configuration |
| `api/models.md` | Getting Started | File Operations |
| `api/capabilities.md` | Capabilities Matrix | Capabilities & Errors |
| `api/errors.md` | Troubleshooting | Error Handling |
| `api/sftp-utils.md` | SFTP Backend | SFTP Backend example |

Mapping for extension API pages:

| API page | Guide link | Example link |
|---|---|---|
| `api/extensions/batch.md` | Batch Operations | Batch Operations |
| `api/extensions/transfer.md` | Transfer Operations | Transfer Operations |
| `api/extensions/glob.md` | Glob Pattern Matching | Glob Pattern Matching |
| `api/extensions/cache.md` | Cache | Caching |
| `api/extensions/observe.md` | Observe | Observe Hooks |
| `api/extensions/otel.md` | Observe | OTel Tracing |
| `api/extensions/arrow.md` | PyArrow Adapter | PyArrow Adapter |
| `api/extensions/dagster.md` | Dagster | Dagster IO Manager, Medallion Dagster |
| `api/extensions/streams.md` | — | Streaming IO |
| `api/extensions/partition.md` | Data Lake Patterns | — |
| `api/extensions/pydantic.md` | Extensions | Config Loaders |
| `api/extensions/yaml.md` | Extensions | Config Loaders |
| `api/extensions/integrity.md` | — | — |
...
|---|---|---|
| `quickstart.md` | Getting Started | `examples/quickstart.py` |
| `file-operations.md` | Getting Started | `examples/file_operations.py` |
| `streaming-io.md` | — | `examples/streaming_io.py` |
| `atomic-writes.md` | Concurrency | `examples/atomic_writes.py` |
| `configuration.md` | Choosing a Backend | `examples/configuration.py` |
| `config-loaders.md` | Extensions | `examples/config_loaders.py` |
| `error-handling.md` | Troubleshooting | `examples/error_handling.py` |
| `capabilities-and-errors.md` | Capabilities Matrix | `examples/capabilities_and_errors.py` |
| `path-model.md` | — | `examples/path_model.py` |
| `store-child.md` | — | `examples/store_child.py` |
| `memory-backend.md` | Memory Backend | `examples/memory_backend.py` |
| `http-backend.md` | HTTP Backend | `examples/http_backend.py` |
| `s3-backend.md` | S3 Backend | `examples/backends/s3_backend.py` |
| `s3-pyarrow-backend.md` | S3-PyArrow Backend | `examples/backends/s3_pyarrow_backend.py` |
| `sftp-backend.md` | SFTP Backend | `examples/backends/sftp_backend.py` |
| `azure-backend.md` | Azure Backend | `examples/backends/azure_backend.py` |
| `batch-operations.md` | Batch Operations | `examples/batch_operations.py` |
| `transfer-operations.md` | Transfer Operations | `examples/transfer_operations.py` |
| `glob-pattern-matching.md` | Glob Pattern Matching | `examples/glob_pattern_matching.py` |
| `caching.md` | Cache | `examples/caching.py` |
| `observe-hooks.md` | Observe | `examples/observe_hooks.py` |
| `otel-tracing.md` | Observe | `examples/otel_tracing.py` |
| `pyarrow-adapter.md` | PyArrow Adapter | `examples/pyarrow_adapter.py` |
| `dagster-io-manager.md` | Dagster | `examples/dagster_io_manager.py` |
| `medallion-dagster.md` | Dagster, Data Lake Patterns | `examples/medallion_dagster/` (folder) |
| `retry-policy.md` | Retry | `examples/retry_policy.py` |
| `health-check.md` | Health Check | `examples/health_check.py` |
