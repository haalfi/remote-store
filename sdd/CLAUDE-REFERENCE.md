...
|                            | entry must carry a link to the migration guide. It cannot |
|                            | check that the linked section covers *this* entry, and it |
|                            | cannot see the softer half at all — see its docstring.    |
