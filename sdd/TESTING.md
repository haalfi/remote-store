...
1. **Every test must have at least one meaningful assertion** [CI-enforced — pending BK-124b]
...
4. **Always use `spec=` with `MagicMock`** [CI-enforced — pending BK-124b]
