...
- `InvalidPath` – If src or dst addresses the store root — under any spelling, and ahead of the source-existence check — or src names a directory, or dst names an existing directory.
