...
# ---------------------------------------------------------------------------
# The former docs-src/llms.txt docs-site-link tests were retired in ID-220:
# llms.txt is now generated by the mkdocs-llmstxt plugin from real page URIs,
# and `mkdocs build --strict` aborts on any missing section page, so there is
# no static file left for this gate to scan.
