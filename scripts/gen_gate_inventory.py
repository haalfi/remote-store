...
_BOUNDS: tuple[str, ...] = (
    ...
    "it is named. Four live instances: `drift_smoke_map.py` and `drift_check.py`'s "
    "`_direct_requirements_for`, both imported by `python -` steps in the "
    "`drift-smoke` composite action; `gen_pages.py`, under `mkdocs.yml`'s "
