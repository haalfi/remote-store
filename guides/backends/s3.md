...
- [S3 listing strategies example](https://github.com/haalfi/remote-store/blob/master/examples/backends/s3_listing_strategies.py) — demonstrates shallow, recursive, and filtering techniques
